"use strict";
(self["webpackChunkfrontend"] = self["webpackChunkfrontend"] || []).push([["default-src_app_shared_modules_card_card_module_ts"],{
...
/* harmony import */ var _angular_material_progress_bar__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/material/progress-bar */ 833);
...
IconComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: IconComponent, selectors: [["app-icon"]], inputs: { icon: "icon" }, decls: 1, vars: 2, consts: [[3, "className"]], template: function IconComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, styles: [".material-icons[_ngcontent-%COMP%]:after, .fas[_ngcontent-%COMP%]:after {\n  content: attr(data-icon);\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
//# sourceMappingURL=default-src_app_shared_modules_card_card_module_ts.js.map